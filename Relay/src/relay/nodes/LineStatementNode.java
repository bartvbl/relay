...
public class LineStatementNode extends CodeStatementNode {
	...
	public LineStatementNode(LocationRange locationRange, ExpressionNode fromX, ExpressionNode fromY, ExpressionNode toX, ExpressionNode toY) {
		super(locationRange, StatementType.LINE); // children are not passed in here because they should be exclusive to this node.
		this.fromX = fromX;
		this.fromY = fromY;
		this.toX = toX;
		this.toY = toY;
